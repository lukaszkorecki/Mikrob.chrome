...
test('status location parsing',function(){
  ...
  var exp = "<span class='pic location'>(Lokacja: <input type='image' src='assets/map_pin_fill_16x16.png' data-action='picture' data-url='http://maps.google.com/maps/api/staticmap?center=brooklyn,%20ny&zoom=14&size=350x350&sensor=true' />)</span>";

  var input1 = "lol @/brooklyn, ny/ hehe";
  var res1 = BodyParser.statusLocation(input1);
  var exp1 = "lol <span class='pic location'>(Lokacja: <input type='image' src='assets/map_pin_fill_16x16.png' data-action='picture' data-url='http://maps.google.com/maps/api/staticmap?center=brooklyn,%20ny&zoom=14&size=350x350&sensor=true' />)</span> hehe";

  var input2 = "lol @/56.32457349, 23.930453480/ hehe";
  var res2 = BodyParser.statusLocation(input2);
  var exp2 = "lol <span class='pic location'>(Lokacja: <input type='image' src='assets/map_pin_fill_16x16.png' data-action='picture' data-url='http://maps.google.com/maps/api/staticmap?center=56.32457349,%2023.930453480&zoom=14&size=350x350&sensor=true' />)</span> hehe";
...
test('parse complete body', function() {
  ...
  exp += " <span class='pic location'>(Lokacja: <input type='image' src='assets/map_pin_fill_16x16.png' data-action='picture' data-url='http://maps.google.com/maps/api/staticmap?center=56.32457349,%2023.930453480&zoom=14&size=350x350&sensor=true' />)</span>";
