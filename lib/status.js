...
var Status = function(blip_obj) {
  ...
  if(blip_obj.user) {
    ...
    this.is_own = (blip_obj.user.login == Mikrob.Service.blipAcc.username);
    ...
    if (blip_obj.user.avatar) {
      ...
      this.user_avatar_url = 'assets/mikrob_icon_48.png';
    }
  ...
  if (blip_obj.recipient) {
    ...
    if (blip_obj.recipient.avatar) {
      ...
      this.recipient_avatar_url = 'assets/mikrob_icon_48.png';
    }
  }
